using UnityEngine;
private sealed class JSONArray.<GetEnumerator>d__18 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public JSONArray.<GetEnumerator>d__18(int <>1__state)
    {
