using UnityEngine;
private sealed class JSONObject.<GetEnumerator>d__19 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public JSONObject.<GetEnumerator>d__19(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        val_7 = this.<>7__wrap1;
        mem[1152921512215526760] = val_2;
        mem[1152921512215526744] = val_3;
        this.<>1__state = -3;
        this.<>7__wrap1 = val_4;
        label_3:
        if((val_7 & 1) != 0)
