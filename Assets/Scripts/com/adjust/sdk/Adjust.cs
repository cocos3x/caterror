...
namespace com.adjust.sdk
{
    public class Adjust : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            val_8 = this.sendInBackground;
            val_4.setSendInBackground(sendInBackground:  (val_8 == true) ? 1 : 0);
            if(val_4 != null)
            {
                    val_4.setEventBufferingEnabled(eventBufferingEnabled:  (this.eventBuffering == true) ? 1 : 0);
                val_9 = this.launchDeferredDeeplink;
            }
            else
            {
                    val_4.setEventBufferingEnabled(eventBufferingEnabled:  (this.eventBuffering == true) ? 1 : 0);
