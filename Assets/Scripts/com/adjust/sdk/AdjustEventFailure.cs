...
namespace com.adjust.sdk
{
    public class AdjustEventFailure
    {
        ...
        public AdjustEventFailure(string jsonString)
        {
            ...
            this.<WillRetry>k__BackingField = System.Convert.ToBoolean(value:  com.adjust.sdk.AdjustUtils.GetJsonString(node:  val_1, key:  com.adjust.sdk.AdjustUtils.KeyWillRetry));
            val_14 = com.adjust.sdk.AdjustUtils.KeyJsonResponse;
            if((com.adjust.sdk.JSONNode.op_Equality(a:  val_1, b:  0)) == true)
            {
                    return;
            }
